...
//Name: F-16_model.ma
//Last modified: Fri, Sep 16, 2016 12:46:34 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -10.511514962706009 6.1378671051438749 9.3770580913880313 ;
	setAttr ".r" -type "double3" -8.7383527298842374 -1496.5999999996864 1.4444441239424737e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "C8BFF191-204C-50BB-AA12-DE9FC33A5FEC";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 12.704167977266973;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.028578078874878399 4.2078185807953421 2.4648347893034086 ;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5 0.45991933345794678 ;
	...
	setAttr -s 3 ".pt";
	setAttr ".pt[15]" -type "float3" 0 0 0.019252099 ;
	setAttr ".pt[36]" -type "float3" 0 0 0.057862666 ;
	setAttr ".pt[47]" -type "float3" 0 -0.53951126 0.1269777 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr -s 8 ".pt[0:7]" -type "float3"  0 5.9604645e-08 0 0 5.9604645e-08 
		0 0 -0.96905118 0 0 -0.96905118 0 0 -0.96905118 0.69966549 0 -0.96905118 -0.25665486 
		0 0 0.69966549 0 0 -0.25665486;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode mesh -n "pasted__pCubeShape2" -p "pasted__pCube2";
	...
	setAttr -s 8 ".pt[0:7]" -type "float3"  0 5.9837475e-08 0 0 5.9837475e-08 
		0 0 -0.96905118 0 0 -0.96905118 0 0 -0.96905118 0.69966549 0 -0.96905118 -0.25665486 
		0 2.3283064e-10 0.69966549 0 2.3283064e-10 -0.25665486;
	setAttr ".ai_translator" -type "string" "polymesh";
